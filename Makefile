...
cov: ## Cobertura gate = 89% (medido 90.02% checkout limpio, hito DoD v0.1 = 70% ALCANZADO, ver docs/COVERAGE_ROADMAP.md)
	...
	@printf "$(YELLOW)Nota:$(RESET) gate 89%% (medido 90.02%%). Hito DoD v0.1 = 70%% alcanzado. Ver $(BOLD)docs/COVERAGE_ROADMAP.md$(RESET)\n"
