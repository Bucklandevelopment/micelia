...
cov: ## Cobertura gate = 75% (medido 76.94%, hito DoD v0.1 = 70% ALCANZADO, ver docs/COVERAGE_ROADMAP.md)
	...
	@printf "$(YELLOW)Nota:$(RESET) gate 75%% (medido 76.94%%). Hito DoD v0.1 = 70%% alcanzado. Ver $(BOLD)docs/COVERAGE_ROADMAP.md$(RESET)\n"
